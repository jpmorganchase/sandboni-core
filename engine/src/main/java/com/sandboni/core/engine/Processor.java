...
public class Processor {
    ...
    private ResultGenerator getResultGeneratorImpl() {
        StopWatch swAll = StopWatchManager.getStopWatch(this.getClass().getSimpleName(), "getResultGeneratorImpl", "ALL").start();
        StopWatch sw1 = StopWatchManager.getStopWatch(this.getClass().getSimpleName(), "getResultGeneratorImpl", "getBuilder").start();
        Builder builder = builderSupplier.get();
        sw1.stop();
        StopWatch sw2 = StopWatchManager.getStopWatch(this.getClass().getSimpleName(), "getResultGeneratorImpl", "builder.getGraph").start();
        DirectedGraph<Vertex, Edge> graph = builder.getGraph();
        sw2.stop();
        StopWatch sw3 = StopWatchManager.getStopWatch(this.getClass().getSimpleName(), "getResultGeneratorImpl", "contextSupplier").start();
        Context context = contextSupplier.get();
        sw3.stop();
        StopWatch sw4 = StopWatchManager.getStopWatch(this.getClass().getSimpleName(), "getResultGeneratorImpl", "create resultGenerator").start();
    ...
    private Builder getBuilder() {
        StopWatch sw1 = StopWatchManager.getStopWatch(this.getClass().getSimpleName(), "getBuilder", "getContext").start();
        Context context = contextSupplier.get();
        sw1.stop();
        StopWatch sw2 = StopWatchManager.getStopWatch(this.getClass().getSimpleName(), "getBuilder", "getBuilder(context)").start();
    ...
    private boolean proceed(ChangeScope<Change> changeScope) {
        StopWatch swAll = StopWatchManager.getStopWatch(this.getClass().getSimpleName(), "proceed", "ALL").start();
    ...
    public ChangeScope<Change> getScope() {
        ...
        try {
            StopWatch swAll = StopWatchManager.getStopWatch(this.getClass().getSimpleName(), "getScope", "ALL").start();
    ...
    private Context createContext() {
        StopWatch sw1 = StopWatchManager.getStopWatch(this.getClass().getSimpleName(), "createContext", "getChangeScope").start();
        ChangeScope<Change> changes = changeScopeSupplier.get();
        sw1.stop();
        StopWatch sw2 = StopWatchManager.getStopWatch(this.getClass().getSimpleName(), "createContext", "createContext Object").start();
    ...
    private Builder getBuilder(Context context) {
        ...
        if (context.getChangeScope().isEmpty()) {
            ...
            StopWatch sw1 = StopWatchManager.getStopWatch(this.getClass().getSimpleName(), "getBuilder(context)", "filter change scope").start();
            ...
            StopWatch sw2 = StopWatchManager.getStopWatch(this.getClass().getSimpleName(), "getBuilder(context)", "moduleContainsChanges").start();
            ...
            Instant start = Instant.now();
            StopWatch sw3 = StopWatchManager.getStopWatch(this.getClass().getSimpleName(), "getBuilder(context)", "executeFinders (scope)").start();
            ...
            start = Instant.now();
            StopWatch sw4 = StopWatchManager.getStopWatch(this.getClass().getSimpleName(), "getBuilder(context)", "execute connectors").start();
            ...
            StopWatch sw5 = StopWatchManager.getStopWatch(this.getClass().getSimpleName(), "getBuilder(context)", "executeFinders (all external tests)").start();
            executeFinders(context);
            sw5.stop();
